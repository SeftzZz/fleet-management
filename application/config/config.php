...
|
*/
$config['base_url'] = 'http://fleetmanagement.fpp';
...
$config['sess_cookie_name'] = 'fleetmanagement_session';
...
$config['csrf_token_name'] = 'csrf_fleetmanagementtoken_name';
$config['csrf_cookie_name'] = 'csrf_fleetmanagementcookie_name';
