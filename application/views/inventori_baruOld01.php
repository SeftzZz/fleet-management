                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#modalFormPO"><i class="fas fa-plus-square"></i>&nbsp;&nbsp; Tambah PO</button>
                            </div>
                        </div>
                        <div class="card-body table-responsive">
                            <table id="tbl_inventoryBaru" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($brgbarus as $row) { ?>
                                        <tr>
                                            <td><?php echo $row->sparepart; ?></td>
                                            <td><?php echo $row->total_qty; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-outline-success"><i class="fas fa-eye"></i></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
