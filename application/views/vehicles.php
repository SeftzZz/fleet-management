                                                        ...
                                                        <td width="8%">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-sm-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" name="no_pol" value="<?php echo set_value('jam',$row->no_pol)?>" class="form-control <?php if (form_error('no_pol')) {echo "is-invalid";} ?>" />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-4">
                                                                                        <div class="form-group">
                                                            ...
                                                            <div class="modal fade" id="mdl_delvehicles<?php echo $row->id ?>">
                                                                <div class="modal-dialog">
                                                                  <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Hapus vehicles</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
