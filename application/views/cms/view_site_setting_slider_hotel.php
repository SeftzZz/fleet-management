      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            <br />
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertSiteSettingSliderHotel/'.$idBusiness.'/') ?>" id="siteSettingSlider" class="form-horizontal form-label-left">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <img id="result-image1" width="100%" src="https://cms.sahirahotelsgroup.com/assets/images/placeholder.png" alt="img" style="width: 250px">
                        <div class="btn btn-primary" data-toggle="modal" data-target="#cropperModal1">Upload image</div>
                    </div>
                    <input type="hidden" name="photoPath1" id="photoPath1" required />
                </div>

                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="imgsmSwiper">Image for Mobile<span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 ">
                        <img id="result-image2" width="100%" src="https://cms.sahirahotelsgroup.com/assets/images/placeholder.png" alt="img" style="width: 150px">
                        <div class="btn btn-primary" data-toggle="modal" data-target="#cropperModal2">Upload image</div>
                    </div>
                    <input type="hidden" name="photoPath2" id="photoPath2" required />
                </div>

                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="titleSwiper">Title <span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6">
                        <input type="text" id="titleSwiper" name="titleSwiper" class="form-control">
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input type="text" id="subtitleSwiper" name="subtitleSwiper" class="form-control">
                    </div>
                </div>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="cropperModalLabel">Image cropper Photo Desktop</h5>
            ...
            <div class="modal fade" id="cropperModal2" tabindex="-1" role="dialog" aria-labelledby="cropperModalLabel2" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="cropperModalLabel2">Image cropper Photo Mobile</h5>
                    <div class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </div>
                  </div>
                  <div class="modal-body">
                    ...
                    <div style="padding-top: 10px;">
                      <input type="hidden" name="dataX" id="dataX" value="412">
                      <input type="hidden" name="dataY" id="dataY" value="915">
                      <input type="hidden" name="dataHeight" id="dataHeight" value="412">
                      <input type="hidden" name="dataWidth" id="dataWidth" value="915">
                      <label class="btn btn-primary btn-upload" for="inputImage2" title="Upload image file">
                        <input type="file" class="sr-only" id="inputImage2" name="imgsmSwiper" accept="image/*">
                        <span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="Import image with Blob URLs"> Import <span class="fa fa-upload"></span>
                        </span>
                      </label>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr id="row-<?php echo $index; ?>">
                  ...
                  <td width="7%"><img src="https://cms.sahirahotelsgroup.com/assets/images/swiper/<?php echo $row->imgsmSwiper; ?>"></td>
          ...
          <div class="modal fade" id="swiperModal<?php echo $row->idSwiper; ?>" tabindex="-2" role="dialog" aria-labelledby="swiperModalLabel" aria-hidden="true" style="z-index: 1049;">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateSiteSettingSliderHotel/'.$idBusiness.'/') ?>" id="siteSettingSlider" class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="titleSwiper">Title <span class="required">*</span></label>
                          <div class="col-md-6 col-sm-6">
                              <input type="text" id="titleSwiper" name="titleSwiper" class="form-control" value="<?php echo $row->titleSwiper ?>">
                          </div>
                      </div>
                      ...
                      <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="subtitleSwiper">Subtitle <span class="required">*</span></label>
                          <div class="col-md-6 col-sm-6">
                              <input type="text" id="subtitleSwiper" name="subtitleSwiper" class="form-control" value="<?php echo $row->subtitleSwiper ?>">
                          </div>
                      </div>
