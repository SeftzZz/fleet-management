        ...
        <tbody>
          ...
          <tr>
            ...
            <?php
              ...
              $this->db->where('nmSegment', 'OTA-SDJ');
            ...
            <div class="input-group">
              <form id="form-type-januari" method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertInvestment_ota') ?>" class="form-horizontal form-label-left">
                <td style="width: 10px;">
                  <input type="hidden" name="segmentInvestment" value="OTA-SDJ">
