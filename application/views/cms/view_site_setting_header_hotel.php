  ...
  <div class="">
    ...
    <div class="row">
      <!-- <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            <br />
            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertSiteSettingHeader') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="durationPackage">Logo Header</label>
                <div class="col-md-6 col-sm-6">
                  <input type="number" id="durationPackage" name="durationPackage" class="form-control" required>
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12">
                  <div class="card">
                    <div class="card-body">
                      <iframe style="overflow-y: hidden;" src="https://web.salamdjourney.com/" width="100%" height="300" frameborder="0" allowfullscreen></iframe>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Setting Site Header <?php echo $idBusiness ?>
            </h2>
            <ul class="nav navbar-right panel_toolbox">
              <li>
                <a class="collapse-link">
          ...
          <div class="x_content form-horizontal form-label-left">
            <br />
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertSiteSettingHeaderHotel') ?>" id="demo-form2" class="form-horizontal form-label-left">
                <input type="hidden" id="idBusiness" name="idBusiness" value="<?php echo $idBusiness ?>" class="form-control" required>
                <div class="item form-group">
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>View Site Header <?php echo $idBusiness ?>
            </h2>
            <ul class="nav navbar-right panel_toolbox">
              <li>
                <a class="collapse-link">
