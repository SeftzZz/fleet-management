      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            <br />
            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertFormVoucherCatalog') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="nmVouchercatalog" required="required" name="nmVouchercatalog" class="form-control" placeholder="New promo from mideast">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="number" id="qtyVouchercatalog" required="required" name="qtyVouchercatalog" class="form-control" placeholder="0">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="priceVouchercatalog" required="required" name="priceVouchercatalog" class="form-control" placeholder="0">
                </div>
              </div>
              <script>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="date" id="expiredVouchercatalog" required="required" name="expiredVouchercatalog" class="form-control" placeholder="New promo from mideast">
                </div>
              </div>
              <div class="item form-group">
          ...
          <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <?php
                foreach($vouchercatalog as $row) {
              ?>
              <tr>
                <td><?php echo $row->nmVouchercatalog ?></td>
                <td><?php echo $row->ketVouchercatalog ?></td>
                <td><?php echo $row->qtyVouchercatalog ?></td>
                <td><?php echo $row->statusVouchercatalog ?></td>
                <td><?php echo $row->createdAtVouchercatalog ?></td>
                <td><a href="<?php echo base_url('cms/home/viewVoucherCatalogDetail/'.$row->idVouchercatalog.'/') ?>" class="btn btn-primary">View detail</a></td>
              </tr>
              <?php }?>
            </tbody>
          </table>
