        ...
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <?php 
                  foreach($our_hotels as $index => $row) {
                ?>
                  <tr>
                    <td><?php echo $row->locale ?></td>
                    <td><?php echo $row->titleHero ?></td>
                    <td><?php echo $row->subtitleHero ?></td>
                    <td><button type="button" class="btn btn-primary editBtn" data-toggle="modal" data-target="#headerModal<?php echo $row->idHero; ?>" data-index="<?php echo $index; ?>" id-header="<?php echo $row->idHero; ?>">Edit</button></td>
                  </tr>
                  <div class="modal fade" id="headerModal<?php echo $row->idHero; ?>" tabindex="-1" role="dialog" aria-labelledby="headerModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="headerModalLabel">Edit Hotel <?php echo $row->idHero; ?></h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                          <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateSiteSettingOurHotels') ?>" id="demo-form2" class="form-horizontal form-label-left">
                              ...
                              <div class="item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                      <input type="text" id="titleHero" name="titleHero" class="form-control" value="<?php echo $row->titleHero ?>">
                                  </div>
                              </div>

                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="subtitleHero">Sub Title <span class="required">*</span></label>
                                  <div class="col-md-6 col-sm-6">
                                      <textarea type="text" id="subtitleHero" name="subtitleHero" class="form-control" rows="7"><?php echo $row->subtitleHero ?></textarea>
                                  </div>
                              </div>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <?php 
                  foreach($hotels as $index => $row) {
                ?>
                  <tr>
                    <td><?php echo $row->emailReservationBusiness ?></td>
                    <td><?php echo $row->Name ?></td>
                    <td><?php echo $row->addres ?></td>
                    <td><?php echo $row->urlwhatsappBusiness ?></td>
                    <td><img src="https://sahirahotelsgroup.com/img/<?php echo $row->image ?>"></td>
