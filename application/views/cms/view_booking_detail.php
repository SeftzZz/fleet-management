    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateFormBooking/'.$this->session->userdata('idBusiness').'/'.$getidBooking.'/') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
              <div class="col-md-4">
              ...
              <script>
                ...
                $(document).ready(function () {
                  // Get the statusBooking dropdown and roomtypeBooking input
                  var statusDropdown = document.getElementById('status');
                  var numberroom = document.getElementById('numberroom');
                  // Attach an event listener to the statusBooking dropdown
                  statusDropdown.addEventListener('change', function () {
                      // Get the selected value
                      var selectedStatus = statusDropdown.value;
                      // Check if the selected status is "Confirm"
                      if (selectedStatus === 'Confirm') {
                          // Set readonly to false for roomtypeBooking
                          numberroom.readOnly = false;
                          numberroom.onclick = function() {
                            var getarrival = document.getElementById('arrival').value;
                            var getdeparture = document.getElementById('departure').value;
                            ...
                            $.ajax({
                              ...
                              data: { arrival: getarrival, departure: getdeparture, ketKamar: roomtype },
                              success: function(response) {
                        ...
                        // Set readonly to true for roomtypeBooking
              ...
              <div class="col-md-4">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-9 col-sm-9">
                    <input type="text" id="updagradeto" name="updagradetoBooking" class="form-control" value="<?php echo $bookingdetail->updagradetoBooking ?>" data-toggle="modal" data-target="#upgradetoModal">
                  </div>
                </div>
                <div class="item form-group">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-9 col-sm-9">
                    <?php 
                      if($bookingdetail->ratecodeBooking == 'OTA SALAM-DJOURNEY') {
                    ?>
                    <input type="text" id="numberroom" name="numberroomBooking" readonly class="form-control" value="<?php echo $bookingdetail->numberroomBooking ?>">
                    <?php
                      } else {
                    ?>
              ...
              <div class="item form-group">
                <div class="col-md-6 col-sm-6 offset-md-3">
                  ...
                  <a href="<?php echo base_url('cms/home/viewBookingInvoice/'.$bookingdetail->idBooking.'/'.$bookingdetail->idBusiness.'/') ?>" class="btn btn-primary">View Invoice</a>
                      ...
                      <tbody>
                          <tr>
                            ...
                            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/chargeFormBooking/'.$this->session->userdata('idBusiness').'/'.$bookingdetail->idBooking.'/') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
                              <input type="hidden" id="departuretimeBooking" name="departuretimeBooking" class="form-control" value="14:00:00">
                              <td><input type="number" name="chargeBooking" class="form-control" placeholder="Amount of charge"></td>
                              <td><textarea type="text" name="ketchargeBooking" class="form-control" rows="5" placeholder="Descriptions..."></textarea></td>
                              <td>
