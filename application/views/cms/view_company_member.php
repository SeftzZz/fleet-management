    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertCompanyMember') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="autocomplete-custom-append" required="required" name="idCompany" class="form-control">
                </div>
              </div>
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="nmCompanymember">Nama Member Company <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="nmCompanymember" required="required" name="nmCompanymember" class="form-control">
                </div>
              </div>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>Name Company</th>
                  <th>Nama Member Company</th>
                  <!-- <th>Action</th> -->
                </tr>
              </thead>
              <tbody>
                <?php
                  foreach($company_member as $row) {
                ?>
                <tr>
                  <!-- <form method="post" title="rate_code" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateRateCode') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left"> -->
                    ...
                    <td><?php echo $row->nmCompanymember ?></td>
