            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr id="row-<?php echo $index; ?>">
                  ...
                  <td><?php echo $row->titleheroAbout; ?></td>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateSiteSettingAbout') ?>" id="demo-form2" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="titleheroAbout">Title Header About <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="titleheroAbout" name="titleheroAbout" class="form-control" value="<?php echo $row->titleheroAbout ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="titleAbout" name="titleAbout" class="form-control" value="<?php echo $row->titleAbout ?>">
                                </div>
                            </div>
