    ...
    <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <?php 
                  foreach($home_offers as $index => $row) {
                ?>
                  <tr>
                    <td><?php echo $row->locale ?></td>
                    <td><?php echo $row->titlehomeHero ?></td>
                    <td><?php echo $row->titleHero ?></td>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateSiteSettingHomeOffers') ?>" id="demo-form2" class="form-horizontal form-label-left">
                              ...
                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="titleHero">Sub Title <span class="required">*</span></label>
                                  <div class="col-md-6 col-sm-6">
                                      <textarea type="text" id="titleHero" name="titleHero" class="form-control" rows="7"><?php echo $row->titleHero ?></textarea>
                                  </div>
                              </div>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $row->locale ?></td>
                    <td><?php echo $row->urlSpecialoffers ?></td>
                    <td><?php echo $row->titleSpecialoffers ?></td>
                    <td><?php echo $row->subtitleSpecialoffers ?></td>
                    <td><img src="<?php echo base_url('assets/images/offers/'.$row->imgSpecialoffers) ?>" width="10%"></td>
                    <td><button type="button" class="btn btn-primary editBtn" data-toggle="modal" data-target="#offersModal<?php echo $row->idSpecialoffers; ?>" data-index="<?php echo $index; ?>" id-header="<?php echo $row->idSpecialoffers; ?>">Edit</button></td>
                  </tr>
                  <div class="modal fade" id="offersModal<?php echo $row->idSpecialoffers; ?>" tabindex="-1" role="dialog" aria-labelledby="offersModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="offersModalLabel">Edit Offers <?php echo $row->titleSpecialoffers; ?></h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                          <form method="post" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateSiteSettingOffers') ?>" id="demo-form2" class="form-horizontal form-label-left">
                              <input type="hidden" readonly name="idSpecialoffers" value="<?php echo $row->idSpecialoffers; ?>" class="form-control">
                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="urlSpecialoffers">URL <span class="required">*</span></label>
                                  <div class="col-md-6 col-sm-6">
                                      <input type="text" id="urlSpecialoffers" name="urlSpecialoffers" class="form-control" value="<?php echo $row->urlSpecialoffers ?>">
                                  </div>
                              </div>

                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="titleSpecialoffers">Title <span class="required">*</span></label>
                                  <div class="col-md-6 col-sm-6">
                                      <input type="text" id="titleSpecialoffers" name="titleSpecialoffers" class="form-control" value="<?php echo $row->titleSpecialoffers ?>">
                                  </div>
                              </div>

                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="subtitleSpecialoffers">Sub Title</label>
                                  <div class="col-md-6 col-sm-6">
                                      <input type="text" id="subtitleSpecialoffers" name="subtitleSpecialoffers" class="form-control" value="<?php echo $row->subtitleSpecialoffers ?>">
                                  </div>
                              </div>

                              <div class="item form-group">
                                  <label class="col-form-label col-md-3 col-sm-3 label-align" for="imgSpecialoffers">Image</label>
                                  <div class="col-md-6 col-sm-6">
                                      <input type="file" id="imgSpecialoffers" name="imgSpecialoffers" class="form-control" value="<?php echo $row->imgSpecialoffers ?>">
                                  </div>
                              </div>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content form-horizontal form-label-left">
            <br />
            <!-- <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertFormKamarPackage/'.$this->session->userdata('idBusiness').'/') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left"> -->
              <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date" id="dateKamar" min="<?php echo date('Y-m-d') ?>" name="dateKamar" class="form-control" value="<?php echo set_value('dateKamar'); ?>" required style="background: #ffff4c82;">
                </div>
              </div>
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="nightPackage">Duration Package *</label>
                <div class="col-md-6 col-sm-6">
                  <input type="number" id="nightPackage" name="nightPackage" class="form-control" min="1" placeholder="1" value="1" required style="background: #ffff4c82;">
                </div>
              </div>
              <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="number" id="durationPackage" name="durationPackage" class="form-control" required style="background: #ffff4c82;">
                </div>
              </div>
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="durationnightPackage">Night</label>
                <div class="col-md-6 col-sm-6">
                  <input type="number" id="durationnightPackage" name="durationnightPackage" class="form-control" required style="background: #ffff4c82;">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="number" min="1" id="qtyKamar" required="required" name="qtyKamar" class="form-control" placeholder="1">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="autocomplete-custom-append-type-kamar" required="required" name="ketKamar" class="form-control" placeholder="Deluxe Room Single">
                </div>
              </div>
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="nmPackage">Nama Package <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="nmPackage" required="required" name="nmPackage" class="form-control" placeholder="-">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <select type="text" name="eventType" id="eventType" class="form-control">
                    <option value="">--Choose Event--</option>
                    <?php 
                      $sahira_hero_offers = array();
                      $this->db->from('sahira_hero_offers');
                      $this->db->where('locale', 'en');
                      $query = $this->db->get();
                      if ($query->num_rows() > 0)
                      {
                        foreach ($query->result() as $row)
                        {
                          $sahira_hero_offers[] = $row;
                        }
                      }
                      $query->free_result(); 
                    ?>
                    <?php 
                      foreach($sahira_hero_offers as $row) {
                    ?>
                    <option value="<?php echo $row->titleHero ?>"><?php echo $row->titleHero ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="ketPackage">Keterangan<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                  <textarea required="required" class="form-control" id="cktextarea" name="ketPackage" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"></textarea>
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 form-group has-feedback">
                  <input type="text" name="hargaROKamar" id="priceInput" required="required" class="form-control" value="">
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function () {
              ...
              function submitCroppedImage(idbuilding) {
                ...
                fData.append('eventType', eventType.value);
                fData.append('locale', locale.value);
                ...
                $.ajax({
                  type: 'POST',
                  url: '<?php echo base_url('cms/home/insertFormKamarPackage/') ?>',
                  data: fData,
            ...
            <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td>Rp <?php echo number_format($row->hargaROKamar) ?></td> -->
