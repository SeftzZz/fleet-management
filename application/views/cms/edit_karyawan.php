  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Profile <?php echo $getkaryawan->emailUser ?>
            </h2>
          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-md-9">
                <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/updateFormKaryawan/'.$getkaryawan->idKaryawan.'/') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="full-name" value="<?php echo $getkaryawan->nmKaryawan ?>" required="required" name="nmKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="date" id="tgllahir" value="<?php echo $getkaryawan->tgllahirKaryawan ?>" required="required" name="tgllahirKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select disabled id="position" name="idLevel" class="form-control" required>
                        <option selected value="<?php echo $getkaryawan->idLevel ?>"><?php echo $getkaryawan->Note ?></option>
                        <?php
                          ...
                          $defaultAccess = array(
                            ...
                            if (isset($user_access) && count($user_access) > 0) {
                                foreach ($user_access as $access) {
                                    $accessName[] = $access->menuName;
                                }
                            } else {
                                $accessName = $defaultAccess[$getkaryawan->idLevel];
                                if ($getkaryawan->idLevel== 6) {
                                    if ($getkaryawan->idDep == 5) {
                                        $accessName = array("FNB");
                                    } else if ($getkaryawan->idDep == 8) {
                                        $accessName = array("FRONT_OFFICE");
                                    } else if ($getkaryawan->idDep == 7) {
                                        $accessName = array("HOUSE_KEEPING");
                                    } else if ($getkaryawan->idDep == 10) {
                                        $accessName = array("FRONT_OFFICE", "FNB", "TOOL_MARKETING");
                                    } else {
                                        $accessName = array();
                                    }
                                }
                            ...
                            <?php foreach ($menu_header as $menu) { ?>
                                <div class="form-check">
                                    <input class="form-check-input" name="access[]" type="checkbox" id="<?php echo $menu->name?>" value="<?php echo $menu->name?>"
                                        <?php echo in_array($menu->name, $accessName)  ? 'checked' : '' ?>>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select disabled id="departement" name="idDep" class="form-control" required>
                        <option selected value="<?php echo $getkaryawan->idDep ?>"><?php echo $getkaryawan->DepName ?></option>
                        <?php
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="mobile" value="<?php echo $getkaryawan->mobileKaryawan ?>" required="required" name="mobileKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="email" value="<?php echo $getkaryawan->emailKaryawan ?>" disabled name="emailKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="password" id="password" value="" name="passwordKaryawan" class="form-control ">
                    </div>
                  </div>
                  <?php
                    if($this->session->userdata('level') == 1 || $this->session->userdata('level') == 7) {
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select id="office" name="officeKaryawan" class="form-control" required>
                        <option selected value="<?php echo $getkaryawan->idBusiness ?>"><?php echo $getkaryawan->Name ?></option>
                        <?php
                        if ($this->session->userdata('level') == '7') {
                          $user_level = array();
                  ...
                  <?php } else {
                  ?>
                  <select disabled id="office" name="officeKaryawan" class="form-control" required>
                    <?php
                    if ($this->session->userdata('level') == '7') {
                      $user_level = array();
                      $this->db->from('Business_Detail');
                    ...
                    foreach($user_level as $row) {
                    ?>
                      <option value="<?php echo $getkaryawan->idBusiness ?>"><?php echo $getkaryawan->Name ?></option>
                    <?php
                    }
                    ?>
                  </select>
                  ...
                  <style type="text/css">
                    ...
                    <div class="item form-group" style="display: flex">
                        <input type="hidden" name="photoPath" id="photoPath" value="<?php echo $getkaryawan->imgKaryawan ?>"/>
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Photo <span class="required">*</span>
                        </label>
                        <div class="image-container">
                            <img id="result-image" width="100%" src="<?php echo base_url('assets/images/karyawan/'.$getkaryawan->imgKaryawan) ?>" alt="img" style="width: 250px">
                        ...
                        <div class="btn btn-primary" style="height: 36px;" data-toggle="modal" data-target="#cropperModal">Upload image</div>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="linkedin" value="<?php echo $getkaryawan->linkedinKaryawan ?>" required="required" name="linkedinKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="instagram" value="<?php echo $getkaryawan->instagramKaryawan ?>" required="required" name="instagramKaryawan" class="form-control ">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="text" id="facebook" value="<?php echo $getkaryawan->facebookKaryawan ?>" required="required" name="facebookKaryawan" class="form-control ">
                    </div>
                  </div>
