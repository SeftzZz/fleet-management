    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form method="post" title="starter-plan" enctype="multipart/form-data" action="<?php echo base_url('cms/home/insertFnbMenu') ?>" id="demo-form2" id="demo-form2" class="form-horizontal form-label-left">
              ...
              <div class="item form-group">
                ...
                <!-- <script>
                  document.getElementById('typeMenu').addEventListener('change', function () {
                    ...
                    const isPackages = selectedOption.getAttribute('data-is-packages');

                    // Display or hide the kategoriMenu based on isPackages
                    const kategoriMenu = document.getElementById('kategoriMenu');
                    const ketMenu = document.getElementById('ketMenu');
                    if (isPackages === '1') {
                      kategoriMenu.style.display = 'block';
                      ketMenu.style.display = 'none';
                    } else {
                      kategoriMenu.style.display = 'none';
                      ketMenu.style.display = 'block';                      
                    }
                  });
                </script> -->
              </div>
              ...
              <div class="item form-group">
                  ...
                  <img id="result-image-food" width="100%" src="<?php  echo empty($fnbMenu->pictureUrlMenu) ? 'https://cms.onixlabs.tech/assets/images/placeholder.png' : $fnbMenu->pictureUrlMenu; ?>" alt="img" style="width: 250px">
                  <div class="btn btn-warning" style="margin-left: 10px;" data-toggle="modal" data-target="#cropperModal">Upload image</div>
                      ...
                      <script>
                          ...
                          $(document).ready(function () {
                              $('#cropperModal').on('shown.bs.modal', function () {
                                  ...
                                  var uploadedImageURL = './assets/images/menu/';
